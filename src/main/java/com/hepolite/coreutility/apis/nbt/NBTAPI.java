...
public class NBTAPI
{
	...
	public final static ItemStack setTag(ItemStack itemStack, NBTTag tag)
	{
	...
	/** Assigns a NBTTag to the given Entity. Returns the same entity that was passed in */
	public final static Entity setTag(Entity entity, NBTTag tag)
	{
	...
	public final static NBTTag getTag(Entity entity)
	{
		Object nmsEntity = REntity.cbGetHandle.invoke(entity);
	...
	/** Returns the type of the nbt tag that is passed in */
	@SuppressWarnings({
			"unchecked",
			"rawtypes"
	})
